        ...
        methods: {
            async init() {
                ...
                loader.load(process.env.BASE_URL + 'static/earth3D/lineData.json', function (data) {
                    ...
                    // mapGroup.rotation.set(0,-Math.PI,0)
                    scene.add(mapGroup);
            ...
            addSubwayLine() {
                ...
                var loader = new THREE.FileLoader();
                loader.setResponseType('json');
                loader.load(process.env.BASE_URL + 'static/earth3D/铁路线.json', function (data) {
                    let allPointArr = [];
                    ...
                    data.features.forEach(obj => {
                        ...
                        obj.geometry.coordinates.forEach(arr => {
                            ...
                            arr.forEach(elem => {
                                // 经纬度转球面坐标
                                var coord = that.lon2xyz(R, elem[0], elem[1])
                    ...
                    subwayGroup.add(that.addLineSegmentSub(allPointArr))  
                    // subwayGroup.rotation.set(0,-Math.PI,0) 
